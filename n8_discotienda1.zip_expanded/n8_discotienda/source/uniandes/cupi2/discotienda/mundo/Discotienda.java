...
public class Discotienda
{
    ...
    public void generarReporteCanciones() throws FileNotFoundException {
    	...
    	try (PrintWriter pluma = new PrintWriter(archivo)) {
			...
			for(int i=0; i<discos.size(); i++) {
				...
				if ((miDisco.darGenero().equals("Rock") || miDisco.darGenero().equals("Pop")) && miDisco.darPrecioDisco()>3500) {
	            
				pluma.println("Nombre del disco: "+ miDisco.darNombreDisco());
    ...
    public String metodo1() {	
        try {
            ...
            return "Error al generar reporte, el tipo: " + e;
        }
    }
    /**
